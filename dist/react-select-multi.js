...
console.log('*****************');
console.log('stylesheet:', _style2.default);
console.log('stylesheet.toString():', _style2.default.toString());
...
var SelectBase = function (_Component) {
  ...
  function SelectBase() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectBase.__proto__ || Object.getPrototypeOf(SelectBase)).call.apply(_ref, [this].concat(args))), _this), _this.handleSearch = function (e) {
  ...
  _createClass(SelectBase, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          isMultipleSelect = _props.isMultipleSelect,
          isSearchable = _props.isSearchable,
          isOpen = _props.isOpen,
          toggleOpen = _props.toggleOpen,
          onCheck = _props.onCheck,
          searchTerm = _props.searchTerm,
          placeholderControl = _props.placeholderControl,
          placeholderSearch = _props.placeholderSearch;


      var styles = this.props.styles ? this.props.styles : _style2.default;

      var arrowStyles = (_arrowStyles = {}, _defineProperty(_arrowStyles, styles.expandIcon, !isOpen), _defineProperty(_arrowStyles, styles.collapseIcon, isOpen), _arrowStyles);

      var selectedLength = void 0;

      if ((_immutable.Map.isMap(selected) || _immutable.List.isList(selected)) && !Array.isArray(selected)) {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          selectedLength ? options.filter(function (o) {
        ...
        isOpen ? _react2.default.createElement(
          'div',
          { className: 'rsm-open-wrapper' },
          isSearchable ? _react2.default.createElement(
            'div',
...
exports.constants = exports.actions = exports.reducer = exports.SelectConnected = exports.SelectState = exports.SelectBase = undefined;

var _SelectBase2 = __webpack_require__(16);

var _SelectBase3 = _interopRequireDefault(_SelectBase2);

var _SelectState2 = __webpack_require__(21);

var _SelectState3 = _interopRequireDefault(_SelectState2);

var _SelectConnected2 = __webpack_require__(55);

var _SelectConnected3 = _interopRequireDefault(_SelectConnected2);

var _reducer2 = __webpack_require__(57);
...
exports.SelectBase = _SelectBase3.default;
exports.SelectState = _SelectState3.default;
exports.SelectConnected = _SelectConnected3.default;
...
exports.SelectStateComponent = undefined;
...
var _reactClickout = __webpack_require__(25);

var _reactClickout2 = _interopRequireDefault(_reactClickout);

var _SelectBase = __webpack_require__(16);
...
var SelectStateComponent = exports.SelectStateComponent = function (_Component) {
  _inherits(SelectStateComponent, _Component);

  function SelectStateComponent(props) {
    _classCallCheck(this, SelectStateComponent);

    var _this = _possibleConstructorReturn(this, (SelectStateComponent.__proto__ || Object.getPrototypeOf(SelectStateComponent)).call(this, props));
  ...
  _createClass(SelectStateComponent, [{
    ...
    key: 'render',
    value: function render() {
      return _react2.default.createElement(_SelectBase2.default, {
        id: this.props.id,
...
var Wrapped = (0, _reactClickout2.default)(SelectStateComponent);
    ...
    _createClass(Clickout, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(ToWrap, _extends({}, this.props, {
            ref: function ref(c) {
...
var ACTIONS = ['RSM_ADD_SELECT', 'RSM_TOGGLE_OPEN', 'RSM_HANDLE_CLICKOUT', 'RSM_SEARCH_OPTIONS', 'RSM_SAVE_SELECTED', 'RSM_REMOVE_SELECT'];
...
exports.removeSelect = exports.saveSelected = exports.searchOptions = exports.toggleOpen = exports.addSelect = undefined;
...
var addSelect = function addSelect(data) {
  return {
    type: _constants2.default.RSM_ADD_SELECT,
    data: data
  };
};

var searchOptions = function searchOptions(data) {
  return {
    type: _constants2.default.RSM_SEARCH_OPTIONS,
    data: data
  };
};

var toggleOpen = function toggleOpen(data) {
  return {
    type: _constants2.default.RSM_TOGGLE_OPEN,
    data: data
  };
};

var saveSelected = function saveSelected(data) {
  return {
    type: _constants2.default.RSM_SAVE_SELECTED,
    data: data
  };
};

var removeSelect = function removeSelect(data) {
  return {
    type: _constants2.default.RSM_REMOVE_SELECT,
    data: data
  };
};
...
exports.removeSelect = removeSelect;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_hoist_non_react_statics__ = __webpack_require__(58);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_verifyPlainObject__ = __webpack_require__(50);
...
exports.SelectConnectedComponent = undefined;
...
var SelectConnectedComponent = exports.SelectConnectedComponent = function (_Component) {
  _inherits(SelectConnectedComponent, _Component);

  function SelectConnectedComponent() {
    var _ref;

    var _temp, _this, _ret;

    _classCallCheck(this, SelectConnectedComponent);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectConnectedComponent.__proto__ || Object.getPrototypeOf(SelectConnectedComponent)).call.apply(_ref, [this].concat(args))), _this), _this.onCheck = function (checkboxValue) {
      return function () {
        var _this$props = _this.props,
            id = _this$props.id,
            selected = _this$props.selected,
            isMultipleSelect = _this$props.isMultipleSelect;

        var updatedSelected = [];
        if (isMultipleSelect) {
          if (selected.includes(checkboxValue)) {
            updatedSelected = selected.filter(function (s) {
              return s !== checkboxValue;
            });
          } else {
            updatedSelected = [].concat(_toConsumableArray(selected), [checkboxValue]);
          }
          _this.props.saveSelected({ id: id, selected: updatedSelected });
        } else {
          // not multipleSelect
          _this.props.saveSelected({ id: id, selected: [checkboxValue] });
          _this.props.toggleOpen({ id: id, isOpen: false });
        }
      };
    }, _this.onToggleOpen = function () {
      _this.props.toggleOpen({ id: _this.props.id, isOpen: !_this.props.isOpen });
    }, _this.handleClickout = function () {
      if (!_this.props.isOpen) return;
      _this.props.toggleOpen({ id: _this.props.id, isOpen: false });
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }

  _createClass(SelectConnectedComponent, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var id = this.props.id;

      this.props.addSelect({ id: id });
    }
  }, {
    key: 'componentWillReceiveProps',
    value: function componentWillReceiveProps(nextProps) {
      var id = nextProps.id,
          initialSelected = nextProps.initialSelected;

      if (nextProps.initialSelected[0] !== this.props.initialSelected[0]) {
        this.props.saveSelected({ id: id, selected: initialSelected });
      }
    }
  }, {
    key: 'componentWillUnmount',
  ...
  return SelectConnectedComponent;
}(_react.Component);
...
var mapDispatchToProps = {
  addSelect: _actions.addSelect,
  toggleOpen: _actions.toggleOpen,
  saveSelected: _actions.saveSelected,
  searchOptions: _actions.searchOptions,
  removeSelect: _actions.removeSelect
};

var Wrapped = (0, _reactClickout2.default)(SelectConnectedComponent);
...
var _initial_state = __webpack_require__(56);
...
var reducer = function reducer() {
  ...
  switch (action.type) {
    case _constants2.default.RSM_ADD_SELECT:
      {
        var id = action.data.id;

        if (!id) return state;
        return state.merge(_defineProperty({}, id, { isOpen: false, selected: [], searchTerm: '' }));
      }
    case _constants2.default.RSM_TOGGLE_OPEN:
      {
        var _action$data = action.data,
            _id = _action$data.id,
            isOpen = _action$data.isOpen;

        return state.mergeIn([_id, 'isOpen'], isOpen);
      }
    case _constants2.default.RSM_SEARCH_OPTIONS:
      {
        var _action$data2 = action.data,
            _id2 = _action$data2.id,
            searchTerm = _action$data2.searchTerm;

        return state.mergeIn([_id2, 'searchTerm'], searchTerm);
      }
    case _constants2.default.RSM_SAVE_SELECTED:
      {
        var _action$data3 = action.data,
            _id3 = _action$data3.id,
            selected = _action$data3.selected;

        return state.setIn([_id3, 'selected'], (0, _immutable.fromJS)(selected));
      }
    case _constants2.default.RSM_REMOVE_SELECT:
      {
        var _id4 = action.data.id;

        return state.delete(_id4);
      }
    default:
      {
        return state;
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(76);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(54), __webpack_require__(87)(module)))
